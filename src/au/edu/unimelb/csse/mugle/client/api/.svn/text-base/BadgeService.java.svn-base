...
/**
 * Developer API for accessing the badges (achievements) system. This allows
 * each game to award the user with badges, as well as update the progress of
 * badges.
 */
...
public interface BadgeService extends RemoteService {
	 ...
	 * @return List of strings corresponding to the 'name' field of each badge
	 *         in the current game.
	 */
