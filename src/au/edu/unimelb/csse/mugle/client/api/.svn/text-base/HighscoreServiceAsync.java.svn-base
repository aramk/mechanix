...
/**
 * Developer async API for accessing the current user's high-score. This allows
 * the game to save the user's highest score.
 */
public interface HighscoreServiceAsync {
	 ...
	 */
	void saveScore(String gameToken, int score, AsyncCallback<Void> callback);
