...
public class BadgeServiceImpl extends RemoteServiceServlet implements
	...
	static {
		...
		static_badge_map.put("rescueSnow", new Badge("rescueSnow",
				"Mirror, mirror", "Rescue Snow White", 0));
		static_badge_map.put("rescueDwarves", new Badge("rescueDwarves",
				"Hi ho", "Rescue the seven dwarves", 7));
	}
	...
	private UserBadge get_userbadge(String gameToken, String name)
		...
		// Check that this is really a badge
