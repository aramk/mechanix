...
final class GameToken {
	...
	/**
	 * Check whether a game token has a valid format. The expected format is
	 * that of a UUID version 4 (see http://en.wikipedia.org/wiki/UUID).
	 */
	...
	/**
	 * Check whether a game token has a valid format, and throw a GameTokenError
	 * if it does not.
	 */
