...
public class HighScoreServiceImpl extends RemoteServiceServlet implements
		HighscoreService {
	/**
	 * Test implementation: Store the state in memory. Maps game tokens onto the
	 * user's score for that game.
	 */
	private static Map<String, Integer> game_score_map = new HashMap<String, Integer>();
