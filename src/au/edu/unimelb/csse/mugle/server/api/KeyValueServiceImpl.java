...
public class KeyValueServiceImpl extends RemoteServiceServlet implements
	 ...
	 */
	private static Map<String, Map<String, Serializable>> game_key_value_map = new HashMap<String, Map<String, Serializable>>();
	...
	private Map<String, Serializable> get_key_value_map(String gameToken)
		...
		Map<String, Serializable> key_value_map = game_key_value_map
				.get(gameToken);
