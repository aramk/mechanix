...
/**
 * Provides static (user-independent) information about a badge. This is the
 * information that the developers have provided to describe a badge in the
 * MUGLE control panel.
 */
public class Badge implements Serializable {
   ...
   //constructing a new badge object
	...
	/**
	 * For progress badges, the total number of progress units required to earn
	 * the badge. For non-progress badges, 0.
	 */
	...
	public String toString() {
		return "Badge [" + this.name + ", " + this.displayName + ", "
				+ this.description + ", " + this.maxProgress + "]";
	}
}
