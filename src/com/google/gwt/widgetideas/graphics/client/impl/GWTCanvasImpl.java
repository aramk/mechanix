...
/**
 * Common interface for all Deferred binding implementations of GWTCanvas.
 */
public interface GWTCanvasImpl {
	...
	void drawImage(ImageElement img, double sourceX, double sourceY,
			double sourceWidth, double sourceHeight, double destX,
			double destY, double destWidth, double destHeight);

	void drawImage(Element img, double sourceX, double sourceY,
			double sourceWidth, double sourceHeight, double destX,
			double destY, double destWidth, double destHeight);
